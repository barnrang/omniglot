...
from mini_prior_model import conv_net, hinge_loss, l2_distance, acc, l1_distance
...
if __name__ == "__main__":
    ...
    combine.fit_generator(train_loader,epochs=50,validation_data=val_loader,  use_multiprocessing=True, workers=4, shuffle=False, callbacks=[save_conv, lr_sched, tensorboard])
